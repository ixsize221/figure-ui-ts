...
class Стул extends Мебель {
  ...
  static средняяЦена(){
    Мебель.все -- это массив со всей мебелью
    Мебель.все перебрать цыклом
    посчитать среднюю цену
    консол логнуть ее
  }
}
Мебель.средняяЦена() -- чтоб среднюю цену мебели показывало

let стулПервый = new Стул("Класный стул №1", 50, true, 5000, 3);
let кожаныйСтул = new Стул("Кожаный стул", 45, false, 12000);
let кожаныйСтул11 = new Стул("Кожаный стул 2", 45, false, 12000);
let кожаныйСтул12 = new Стул("Кожаный стул 3", 45, false, 12000);
